/**
 * @web-axag/server — enforce, on the server, what the annotation promised.
 */
...
export { AxagError } from '@web-axag/core';
export type { AxagErrorCode, AxagRefusal } from '@web-axag/core';
